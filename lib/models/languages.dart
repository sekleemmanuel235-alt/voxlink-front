...
/// Classe statique utilisée par language_picker.dart
class AppLanguages {
  static List<Map<String, String>> get all => kSupportedLanguages
      .map((l) => {'code': l.code, 'flag': l.flag, 'label': l.label})
      .toList();

  static Map<String, String>? findByCode(String code) {
    try {
      final l = kSupportedLanguages.firstWhere((l) => l.code == code);
      return {'code': l.code, 'flag': l.flag, 'label': l.label};
    } catch (_) {
      return null;
    }
  }
